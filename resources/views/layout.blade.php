              ...
              <div class="nav__right-item nav__search">
                ...
                <div class="nav__search-box" id="nav__search-box">
                  <form class="nav__search-form">
                    <input type="text" placeholder="Tìm kiếm tin tức" class="nav__search-input">
        ...
        <aside class="col-lg-4 sidebar sidebar--right">
          ...
          <aside class="widget widget_mc4wp_form_widget">
            ...
            <p class="newsletter__text">
              ...
              Đăng ký để nhận tin tức hằng ngày
            </p>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              <aside class="widget widget-logo">
                ...
                <p class="copyright">
                  © 2018 Deus | Thiết kế bởi <a href="https://deothemes.com">DeoThemes</a>
                </p>
            ...
            <div class="col-lg-2 col-md-6">
              <aside class="widget widget_nav_menu">
                ...
                <ul>
                  ...
                  <li><a href="shortcodes.html">Tính năng</a></li>
            ...
            <div class="col-lg-3 col-md-6">
              <aside class="widget widget_mc4wp_form_widget">
                ...
                <p class="newsletter__text">
                  <i class="ui-email newsletter__icon"></i>
                  Đăng ký để nhận thông báo hằng ngày
                </p>
                <form class="mc4wp-form" method="post">
                  <div class="mc4wp-form-fields">
                    <div class="form-group">
